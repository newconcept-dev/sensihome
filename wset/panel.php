...
<html lang="en">
  ...
  // Obtener la ruta de la imagen de perfil desde la sesión
  $profileImageUrl = isset($_SESSION['profileImage']) ? str_replace('/opt/lampp/htdocs/AppsFiles/sensihome/', 'http://localhost/AppsFiles/sensihome/', $_SESSION['profileImage']) : 'dist/img/avatar5.png';
?>
...
<!--   <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <!-- Aqui se generara el contenido de forma dinamica -->
   ...
   if ($modulo == 'estadisticas' || $modulo == '') {
       ...
       include_once './menu/usuarios.php';
   } elseif ($modulo == 'agregarProductos') {
       include_once './menu/agregarProductos.php';
   }
   
   elseif ($modulo == 'productos') {
       include_once './menu/productos.php';
   } elseif ($modulo == 'ventas') {
       include_once './menu/ventas.php';       
   } elseif ($modulo == 'crearUsuario') {
       include_once './menu/crearUsuario.php';
   } elseif ($modulo == 'editarUsuario') {
       include_once './menu/editarUsuario.php';
    }
     elseif ($modulo == 'productos') {
       include_once './menu/productos.php';
    }
    ...
    elseif ($modulo == 'cuentas') {
       include_once './menu/cuentas.php';
    }
    elseif ($modulo == 'recursos') {
       include_once './menu/recursos.php'; 
    }
    elseif ($modulo == 'test') {
       include_once './menu/test.php';
    }
