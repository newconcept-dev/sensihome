...
if ($id > 0) {
    ...
    // Obtener el nombre de la categoría correspondiente al ID del producto
    ...
    if (!$stmtCategoria->execute()) {
        die("Error en la ejecución: " . $stmtCategoria->error);
    }
...
<div class="content-wrapper">
    ...
    <div class="alert alert-warning " role="alert">
        ...
        Modificando informacion del producto <?php echo htmlspecialchars($producto['nombre_producto']); ?>
    </div>
                                ...
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="">
                                                <h2>Registros del producto</h2>
                                            </div>

                                            <div class="form-group active-full">
                                                <label for="nombre_producto">Nombre del Producto</label>
                                                <input type="text" name="nombre_producto" id="nombre_producto" class="form-control" value="<?php echo htmlspecialchars($producto['nombre_producto']); ?>" required>
                                            </div>
                                        ...
                                        <div class="form-group active-full">
                                            ...
                                            <input value="<?php echo htmlspecialchars($producto['existencia']); ?>" required type="text" name="existencia" id="existencia" class="form-control" min="1" maxlength="5" required>
                                        </div>
                                    ...
                                    <div class="col-md-5 ">
                                        ...
                                        <div class="form-group d-flex justify-content-between">
                                            <div class="form-group active-full">
                                                ...
                                                <div class="input-group">
                                                    <input value="<?php echo htmlspecialchars($producto['precio']); ?>" type="number" name="precio" id="precio" class="form-control input-change" min="100" maxlength="10">
                                                    <div class="input-group-append">
                                            ...
                                            <div class="form-group active-full">
                                                ...
                                                <div class="input-group">
                                                    <input value="<?php echo htmlspecialchars($producto['precioVenta']); ?>" type="number" name="precioVenta" id="precioVenta" class="form-control input-change" min="4000" maxlength="10">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <i class="fas fa-dollar-sign icon-color-change"></i>
                                                        </span>
                                        ...
                                        <div class="form-group active-full">
                                            ...
                                            <input value="<?php echo htmlspecialchars($producto['fechaCompra']); ?>" type="date" name="fechaCompra" id="fechaCompra" class="form-control" required>
                                        </div>
                                        <div class="form-group active-full">
                                            <label>Garantía</label>
                                            <input value="<?php echo htmlspecialchars($producto['garantia']); ?>" type="text" name="garantia" id="garantia" class="form-control" required placeholder="90 dias">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3 flex flex-column justify-content-center align-items-center ">
                                        ...
                                        <button type="submit" name="guardar" class="btn btn-primary mt-2 justify-center" >Modificar</button>
                                        </div>
